...
namespace Amazon.Lambda.SignalR
{
    public class DynamoDbSocketConnectionStore : IAWSSocketConnectionStore<SocketConnection>
    {
        ...
        {
            var connection = await _context.LoadAsync<SocketConnection>(connectionId);
        ...
        public Task RemoveConnectionFromGroupAsync(string connectionId, string groupName, CancellationToken cancellationToken = default(CancellationToken))
        {
            throw new NotImplementedException();
        }
